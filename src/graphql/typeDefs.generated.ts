...
export const typeDefs = {
  ...
  definitions: [
    ...
    },
    {
      ...
      loc: { start: 1927, end: 2056 },
    },
    {
      kind: "ObjectTypeDefinition",
      name: { kind: "Name", value: "Query", loc: { start: 2063, end: 2068 } },
      interfaces: [],
      directives: [],
      fields: [
        {
              ...
              type: {
                ...
                type: {
                  ...
                  name: {
                    kind: "Name",
                    value: "ID",
                    loc: { start: 2092, end: 2094 },
                  },
                  loc: { start: 2092, end: 2094 },
                },
                loc: { start: 2092, end: 2095 },
              },
              directives: [],
              loc: { start: 2081, end: 2095 },
            },
          ],
          type: {
            kind: "NamedType",
          ...
          directives: [],
          loc: { start: 2073, end: 2104 },
        },
      ],
      loc: { start: 2058, end: 2106 },
    },
    {
      kind: "ObjectTypeDefinition",
      name: {
      ...
      fields: [
        {
          ...
          arguments: [
            ...
            },
            {
              ...
              type: {
                ...
                loc: { start: 2198, end: 2205 },
              },
              directives: [],
              loc: { start: 2187, end: 2205 },
            },
            {
              kind: "InputValueDefinition",
              name: {
              ...
              type: {
                ...
                loc: { start: 2214, end: 2221 },
              },
              directives: [],
              loc: { start: 2207, end: 2221 },
            },
            {
              kind: "InputValueDefinition",
              name: {
          ...
          type: {
            ...
            name: {
              kind: "Name",
              value: "Review",
              loc: { start: 2239, end: 2245 },
            },
            loc: { start: 2239, end: 2245 },
          },
          directives: [],
          loc: { start: 2126, end: 2245 },
        },
      ],
      loc: { start: 2108, end: 2247 },
    },
    {
      kind: "ObjectTypeDefinition",
      name: { kind: "Name", value: "Query", loc: { start: 2253, end: 2258 } },
      interfaces: [],
      directives: [],
      fields: [],
      loc: { start: 2248, end: 2258 },
    },
  ],
  loc: { start: 0, end: 2259 },
